...
def main() -> int:
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            require("Reset to defaults" in html and "reset_config" in html, "reset escape hatch missing")
            require("memSearchInput" in html and "content-search.json" in html, "content search wiring missing")
            require("content search requires the live console" in html, "honest empty-state hint missing")
