...
| IDEA-023 | Managed extractive memory backend | EN-013 | idea | | | concept from openreflect-gcp-vertex-memorycore prototype: service-side fact extraction (generated vs explicit), user-scoped cross-client memory, first remote backend; peer_reasoning family; provider TBD by deep research |
