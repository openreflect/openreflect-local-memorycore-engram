...
PUBLIC_SAFE_EVALS = (
    ...
    EvalSpec("MEMORYCORE_VERTEX_ADAPTER", ("scripts/validate_mvp_vertex_adapter.py",)),
    EvalSpec("MEMORYCORE_FANOUT", ("scripts/validate_mvp_fanout.py",)),
...
LOCAL_ONLY_SKIPPED = (
    ...
    "MEMORYCORE_CONSOLE_E2E",
    "MEMORYCORE_VERTEX_LIVE_BACKEND",
)
